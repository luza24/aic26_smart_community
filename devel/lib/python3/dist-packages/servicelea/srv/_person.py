...
"""autogenerated by genpy from servicelea/personRequest.msg. Do not edit."""
import codecs
import sys
...
class personRequest(genpy.Message):
  ...
  _type = "servicelea/personRequest"
...
def _get_struct_2B():
    ...
    return _struct_2B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from servicelea/personResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class personResponse(genpy.Message):
  ...
  _type = "servicelea/personResponse"
  _has_header = False  # flag to mark the presence of a Header object
