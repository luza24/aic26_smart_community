...
(cl:defmethod cl:initialize-instance :after ((m <person-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servicelea-srv:<person-request> is deprecated: use servicelea-srv:person-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servicelea-srv:name-val is deprecated.  Use servicelea-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servicelea-srv:age-val is deprecated.  Use servicelea-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servicelea-srv:sex-val is deprecated.  Use servicelea-srv:sex instead.")
  (sex m))
...
(cl:defmethod cl:initialize-instance :after ((m <person-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servicelea-srv:<person-response> is deprecated: use servicelea-srv:person-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <person-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servicelea-srv:result-val is deprecated.  Use servicelea-srv:result instead.")
  (result m))
